            ...
            <div className="row">
              ...
              <div className="col-6">
                <div className="mb-1">
                  ...
                  <select name="categoria" onChange={handelChange} defaultValue="---Selecciones una categoria---" className="form-control" id="">
                    <option disabled>---Selecciones una categoria---</option>
